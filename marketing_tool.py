...
def input_layer():
  ...
  input_search = st.slider('Search Allocation', 0, 5000, 0, 500)
 ...
 with st.container():
     st.markdown(
         ...
         .heatmap-item::before {
            ...
            right: 0px;
            bottom: 0px;
            box-shadow: 0 0 1px rgba(0, 0, 0, 0.7) inset, 0 0 8px rgba(0, 0, 0, 0.3) inset; /* Add an inset shadow for 3D effect */
